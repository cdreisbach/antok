...
namespace antok {
	...
	namespace generators {
		...
		*/
		...
		antok::Function* generateGetVectorAttributes(const YAML::Node& function, std::vector<std::string>& quantityNames, int index);
		...
		antok::Function* generateGetVectorEntry(const YAML::Node& function, std::vector<std::string>& quantityNames, int index);
		antok::Function* generateMass(const YAML::Node& function, std::vector<std::string>& quantityNames, int index);
		antok::Function* generateMass2(const YAML::Node& function, std::vector<std::string>& quantityNames, int index);
